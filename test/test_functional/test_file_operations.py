...
def test_to_from_file(string_only_settings, test_ini_file_path):

    string_only_settings.to_file(test_ini_file_path)

    assert test_ini_file_path.is_file()

    result = Sejings.from_file(test_ini_file_path)
